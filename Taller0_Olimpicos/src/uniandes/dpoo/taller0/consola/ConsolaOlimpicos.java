...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el nombre de un país dado el atleta");
	...
	{
		System.out.println("\n" + "El país de un atleta dado:");
		String atleta = input("Por favor ingrese el nombre del atleta ");
		String resultado = calculadora.paisAtleta(atleta);
		System.out.println("El país del atleta " + atleta + " es " + resultado);
